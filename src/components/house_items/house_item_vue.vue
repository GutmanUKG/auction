...
<!--        </template>-->
<!--       -->
<!--        &lt;!&ndash;Участвует и делает ставку&ndash;&gt;-->
...
<!--  </div>-->
      <div class="item col-lg-3 col-md-6 col-sm-12">
          <div class="item-descr">
              <div class="item-name">
                  <router-link :to="{name: `detail_house`, params: {id: data._id}}">
                      {{data.name}}
                  </router-link>
              </div>
              <div class="item-price">
                  <span>Цена</span>
                  {{formatNumber(data.startPrice)}}
              </div>
          </div>
      </div>
</template>
